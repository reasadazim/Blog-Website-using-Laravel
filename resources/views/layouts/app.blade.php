...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/jo94w11c1kd5e0u2nwssy80dqb4zkac37bhde4p1rge4xt5s/tinymce/5/tinymce.min.js"></script>
    <script>tinymce.init({
    selector:'textarea',
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {{-- <ul class="navbar-nav mr-auto">
                      @if (Auth::check())
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('create_tag') }}">Create Tag</a>
                        </li>
                      @endif
                    </ul> --}}

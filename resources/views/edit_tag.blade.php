...
@include('layouts.dashboard_sidebar')
      ...
      <div class="col-6">
        ...
        {{-- Create Tag Form --}}
        <form action="{{ route('update_tag',$tag_e->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}

        <div class="form-group">
        <label>Tag Name</label>
        <input name="tag_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $tag_e->tag_name }}">
        </div>
